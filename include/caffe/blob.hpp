...
class Blob {
 public:
  ...
  //CG: Setting whether to replace the data with ternary for calculation, will change the private variable EXCHANGE_DATA_TERNARY, resulting in the cpu_data () function returned to ternary_;
  ...
  //CG: uL2Q
  //@phase: TRAIN or TEST 
  //@CompressParameter: the compress param object, which include 4 values.  
