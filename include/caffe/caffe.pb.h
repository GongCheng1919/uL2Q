...
class BlobProto : public ::google::protobuf::Message {
 public:
  ...
  // optional float delta = 10 [default = 1];
  ...
  // optional float alpha = 11 [default = 1];
...
// optional float delta = 10 [default = 1];
inline bool BlobProto::has_delta() const {
  return (_has_bits_[0] & 0x00000001u) != 0;
}
inline void BlobProto::set_has_delta() {
  _has_bits_[0] |= 0x00000001u;
}
inline void BlobProto::clear_has_delta() {
  _has_bits_[0] &= ~0x00000001u;
}
inline void BlobProto::clear_delta() {
  delta_ = 1;
  clear_has_delta();
}
inline float BlobProto::delta() const {
  // @@protoc_insertion_point(field_get:caffe.BlobProto.delta)
  return delta_;
}
inline void BlobProto::set_delta(float value) {
  set_has_delta();
  delta_ = value;
  // @@protoc_insertion_point(field_set:caffe.BlobProto.delta)
}

// optional float alpha = 11 [default = 1];
inline bool BlobProto::has_alpha() const {
  return (_has_bits_[0] & 0x00000002u) != 0;
}
inline void BlobProto::set_has_alpha() {
  _has_bits_[0] |= 0x00000002u;
}
inline void BlobProto::clear_has_alpha() {
  _has_bits_[0] &= ~0x00000002u;
}
inline void BlobProto::clear_alpha() {
  alpha_ = 1;
  clear_has_alpha();
}
inline float BlobProto::alpha() const {
  // @@protoc_insertion_point(field_get:caffe.BlobProto.alpha)
  return alpha_;
}
inline void BlobProto::set_alpha(float value) {
  set_has_alpha();
  alpha_ = value;
  // @@protoc_insertion_point(field_set:caffe.BlobProto.alpha)
}
